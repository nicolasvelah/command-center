        ...
        <div id="wiki-text">
          ...
          <div id="tablero">
            ...
            <div className="jerarquia-uno">
              ...
              <div className="jerarquia-dos">
                ...
                <p>
                  En esta columna podrás ver todas las órdenes nuevas asignadas
                  a tu usuario en color blanco.
                </p>
                <img
                ...
                <div className="jerarquia-tres">
                  ...
                  <p>
                    ...
                    órdenes de un modo más visual y sencillo estas tareas
                  ...
                  <p>
                    ...
                    donde el proveedor informe desde su aplicación que ha
                    iniciado el servicio, toda orden con proveedor asignada
                    mostrará un estado de acuerdo a estados de la aplicación del
                    proveedor.
                  </p>
                  <img
                  ...
                  <p>
                    ...
                    tenido inconvenientes para contactar con el cliente
                    reiteradas veces, dichas tareas no pueden ser cerradas
                    mientras no se verifique que el servicio concluyó por lo que
                    para una mejor organización puedes utilizar esta columna
                    para apartar aquellas órdenes que requieran esperar un poco
                    para atenderlas por cualquier motivo.
                  </p>
                  <img
                ...
                <p>
                  ...
                  , por lo que una vez{' '}
                  <b>
                    la orden pase a estado resuelto las aplicaciones de clientes
                    y proveedores serán liberadas
                  </b>{' '}
                  y se solicitará al cliente el <b>rate del servicio</b> y
                  permitirá el ingreso de una nueva orden de ese cliente, así
                  como el proveedor podrá recibir una nueva orden.
                </p>
                <p>
                  <b>IMPORTANTE:</b> Mientras las órdenes se encuentren en
                  cualquiera de las otras columnas que no sea Resueltos las
                  aplicaciones no podrán ingresar o recibir nuevas órdenes. Por
                  lo que la liberación de las mismas está en las manos de los
                  operadores.
                </p>
              </div>
              <p>
              ...
              <p>
                ...
                del cliente y proveedor y accionar para resolver sus problemas.
                Puedes arrastrarlas a cualquier columna para cambiar su estado.
              </p>
              ...
              <div className="jerarquia-dos">
                ...
                <p>
                  Añade aquí las notas que consideres necesarias con relación a
                  la orden. A esta información sólo tendrá acceso el operador
                  que añadió la nota y su supervisor.
                </p>
                <img
          ...
          <div id="creartarea">
            ...
            <p>
              ...
              usuario y podrás verlas de inmediato en el tablero en la columna
              de asignados.
            </p>
            <img
          ...
          <div id="supervisores">
            <h2>SUPERVISORES</h2>
            <p>
              El User Supervisor cuenta con las mismas funciones que un Operador
              con algunas herramientas adicionales de monitoreo, por lo que todo
              supervisor debe entender el user Operador. En esta parte
              detallaremos todas aquellas funciones que no se trataron en
              Operador.
            </p>
          </div>
        </div>
